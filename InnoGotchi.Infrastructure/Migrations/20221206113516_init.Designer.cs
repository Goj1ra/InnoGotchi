...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InnoGotchi.Core.Entities.UserStatistics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AverageFeeding")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AveregePetsAge")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AveregeThirst")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("InnoGotchi.Core.Entities.Pet", b =>
                {
                    ...
                    b.HasOne("InnoGotchi.Core.Entities.PetsBody", "PetsBody")
                        .WithOne("Pet")
                        .HasForeignKey("InnoGotchi.Core.Entities.Pet", "Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("InnoGotchi.Core.Entities.UserStatistics", b =>
                {
                    b.HasOne("InnoGotchi.Core.Entities.User", "User")
                        .WithOne("Statistics")
                        .HasForeignKey("InnoGotchi.Core.Entities.UserStatistics", "Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
